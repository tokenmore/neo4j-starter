...
public class TestController {
    ...
    public Map<String, Object>  getBaoAnTelRelationBycaseId(){
        Map<String, Object> map = new HashMap();
        List<Node> nodeList = new ArrayList<>();
        List<Links> linksList = new ArrayList<>();
        List<BaoAnTelRelation> lis = baoAnTelRelationRepsitory.getBaoAnTelRelationBycaseId("CHQ153000008413");
        RelationResult result = SetRelationPropertiesUtils.setBaoAnTelPropertiesUtils(lis, nodeList, linksList);
    ...
    public HashMap<String,Object> getAllRelations(){
        ...
        String sql = "match p1=(n1:AccidentCase)-[r1:治疗于]->(n2:Hospital) with p1,n1,n2,r1 match p2=(n1)-" +
                "[r2:业务归属于]->(n3:Employee) with p1,p2,n1,n2,n3,r1,r2 match p3=(n4:Customer)-" +
                "[r3:是投保人]->(n1) with p1,p2,p3,n1,n2,n3,n4,r1,r2,r3 match p4=(n5:Telephone)-" +
                "[r4:是报案电话]->(n1) with n1,n2,n3,n4,r1,r2,r3,n5,r4,p1,p2,p3,p4 match p5=(n5)-" +
                "[r5:是领款电话]->(n1) with p1,p2,p3,p4,p5,n1,n2,n3,n4,r1,r2,r3,n5,r4,r5 match " +
                "p6=(n4)-[r6:使用]->(n5) with p1,p2,p3,p4,p5,p6,n1,n2,n3,n4,r1,r2,r3,n5,r4,r5,r6 " +
                "match p7=(n4)-[r7:是被保人]->(n1) with p1,p2,p3,p4,p5,p6,p7 ,n1,n2,n3,n4,r1,r2,r3," +
                "n5,r4,r5,r6,r7 match p8=(n4)-[r8:是报案人]->(n1) with p1,p2,p3,p4,p5,p6,p7,p8, n1" +
                ",n2,n3,n4,r1,r2,r3,n5,r4,r5,r6,r7,r8 match p9=(n4)-[r9:是领款人]->(n1)   return id(n1)" +
                " as accidentId,n1.orgno as orgno,n1.pfmoney as pfmoney,n1.caseId as caseId,n1.qzflag as qzflag" +
    ...
    @RequestMapping("/getFullRelations")
    public HashMap<String,Object> getFullRelations(@RequestParam("caseId")String caseId){
        HashMap<String,Object> map = new HashMap<>();
        List<Node> nodeList = new ArrayList<>();
        List<Links> linkList = new ArrayList<>();
        List<LingKuanRelation> lingKuanRelationBycaseId = lingKuanRelationRepsitory.findLingKuanRelationBycaseId(caseId);
...
//                "n4.customerId as custId,n4.customerName as customerName,id(n5) as telphoneId,n5.telId as " +
//                "telId,type(r1),type(r2),type(r3),type(r4),type(r5),type(r6),type(r7),type(r8),type(r9)";
//        System.out.println(caseId);
//        HashMap<String, Object> map = neo4jUtils.matchNodesAndRelations(sql);
//        return map;
//    }
