...
(function () {
    ...
    function n(t, e, n, M) {
        ...
        function j(t) {
            ...
            e.append("circle").attr("class", "foreground-circle").style("fill", function(d){return colors(d.color)}).style("cursor", "move").style("stroke-width", "3px").style("stroke", "#18769f").attr("flag",false);
            d = d.merge(e);
