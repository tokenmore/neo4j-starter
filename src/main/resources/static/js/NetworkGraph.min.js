...
(function () {
    ...
    function n(t, e, n, M) {
        ...
        var a = d3.forceSimulation().alpha(1).alphaDecay(.002).alphaMin(.002).force("r", null).force("center", d3.forceCenter(typeof arguments[2] !== "undefined" ? n : K.width / 2, typeof arguments[3] !== "undefined" ? M : K.height / 2)).force("link", d3.forceLink().id(function (t) {
            return t.id
        ...
        var o = d3.forceSimulation().alpha(1).alphaDecay(.01).alphaMin(.002).force("r", d3.forceRadial(100, typeof arguments[2] !== "undefined" ? n : K.width / 2, typeof arguments[3] !== "undefined" ? M : K.height / 2)).force("center", d3.forceCenter(typeof arguments[2] !== "undefined" ? n : K.width / 2, typeof arguments[3] !== "undefined" ? M : K.height / 2)).force("link", d3.forceLink().id(function (t) {
            return t.id
        ...
        function Y(t) {
            i = t;
            if (e === "force") {
                a.nodes(t.nodes).force("link").links(t.links)
            } else if (e === "radius") {
